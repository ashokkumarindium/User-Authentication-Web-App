...
from .views import edit, dashboard, register,new_transaction,clearall,transfer,initiatetransfer
...
urlpatterns = [
    ...
    path('initiatetransfer',initiatetransfer,name = 'initiatetransfer'),
